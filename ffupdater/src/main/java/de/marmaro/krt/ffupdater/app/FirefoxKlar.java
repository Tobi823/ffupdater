 ...
 */
public class FirefoxKlar extends BaseApp {
    ...
    public String getDisplayTitle(Context context) {
        return context.getString(R.string.firefox_klar_title);
    }

    @Override
    public String getDisplayDescription(Context context) {
        return context.getString(R.string.firefox_klar_description);
    }
    ...
    public Optional<String> getInstalledVersion(Context context) {
        return getInstalledVersionFromSharedPreferences(context, "device_app_register_FIREFOX_KLAR_version_name");
    }
