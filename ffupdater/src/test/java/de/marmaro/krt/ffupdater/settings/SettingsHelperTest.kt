...
class SettingsHelperTest {
    ...
    fun getAutomaticCheck_userHasNotChangedSetting_returnDefaultValueTrue() {
        assertTrue(SettingsHelper(mockContext).automaticCheck)
    }
    ...
    fun getAutomaticCheck_userDisabledIt_returnFalse() {
        ...
        assertFalse(SettingsHelper(mockContext).automaticCheck)
    }
    ...
    fun getCheckInterval_userHasNotChangedSetting_returnDefaultValue() {
        assertEquals(defaultCheckIntervalDuration, SettingsHelper(mockContext).checkInterval)
    }
    ...
    fun getCheckInterval_withPositiveValue_returnValue() {
        ...
        assertEquals(Duration.ofMinutes(42), SettingsHelper(mockContext).checkInterval)
    }
    ...
    fun getDisableApps_userHasNotChangedSetting_returnEmptySet() {
        assertTrue(SettingsHelper(mockContext).disabledApps.isEmpty())
    }
    ...
    fun getDisableApps_withOneApp_Brave_returnApps() {
        ...
        assertThat(SettingsHelper(mockContext).disabledApps, containsInAnyOrder(App.BRAVE))
    }
    ...
    fun getDisableApps_withOneApp_FirefoxBeta_returnApps() {
        ...
        assertThat(SettingsHelper(mockContext).disabledApps, containsInAnyOrder(App.FIREFOX_BETA))
    }
    ...
    fun getDisableApps_withOneApp_FirefoxFocus_returnApps() {
        ...
        assertThat(SettingsHelper(mockContext).disabledApps, containsInAnyOrder(App.FIREFOX_FOCUS))
    }
    ...
    fun getDisableApps_withOneApp_FirefoxKlar_returnApps() {
        ...
        assertThat(SettingsHelper(mockContext).disabledApps, containsInAnyOrder(App.FIREFOX_KLAR))
    }
    ...
    fun getDisableApps_withOneApp_FirefoxLite_returnApps() {
        ...
        assertThat(SettingsHelper(mockContext).disabledApps, containsInAnyOrder(App.FIREFOX_LITE))
    }
    ...
    fun getDisableApps_withOneApp_FirefoxNightly_returnApps() {
        ...
        assertThat(SettingsHelper(mockContext).disabledApps, containsInAnyOrder(App.FIREFOX_NIGHTLY))
    }
    ...
    fun getDisableApps_withAllApps_returnApps() {
        ...
        assertTrue(SettingsHelper(mockContext).disabledApps.containsAll(App.values().toList()))
    }
