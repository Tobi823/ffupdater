...
public class MetadataCacheTest {
    ...
    public void getVersionName_withData_returnEmptyString() {
        ...
        assertEquals("37.27.64", metadataCache.getVersionName(App.FENIX));
    }
    ...
    public void getDownloadUrl_withData_returnEmptyString() {
        ...
        assertEquals("https://something.com/index/app.apk", metadataCache.getDownloadUrl(App.FENIX));
    }
    ...
    public void isTimestampTooOld_withNewTimestamp_returnFalse() {
        ...
        assertFalse(metadataCache.isTimestampTooOld(App.FENIX));
    }
    ...
    public void isTimestampTooOld_withOldTimestamp_returnFalse() {
        ...
        assertTrue(metadataCache.isTimestampTooOld(App.FENIX));
    }
